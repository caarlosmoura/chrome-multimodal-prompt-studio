...
export const resources = {
  'pt-BR': {
    translation: {
      ...
      generationControls: 'Controles',
      generationControlsHelp: 'Temperature ajusta criatividade. Top K ajusta quantas opcoes o modelo considera.',
      ...
      temperatureHelp:
        'Controla o nivel de variacao das respostas. Valores baixos deixam a saida mais objetiva e previsivel; valores altos aumentam criatividade e variacao.',
      topK: 'Top K',
      topKHelp:
        'Limita quantas opcoes de proximo token o modelo considera. Valores baixos deixam a resposta mais focada; valores altos aumentam diversidade.',
      prompt: 'Prompt',
      ...
      ideaCards: [
        'Resumo de reunioes com decisoes e proximos passos.',
        'Leitura de comprovantes e notas com campos-chave.',
        'Analise de screenshots para suporte interno.',
        'Briefing de campo com fotos e notas de voz.',
        'Triagem de chamados por imagem, audio e texto.',
        'Matriz de risco a partir de evidencias multimodais.',
      ],
    },
  },
  'en-US': {
    translation: {
      ...
      generationControls: 'Controls',
      generationControlsHelp: 'Temperature adjusts creativity. Top K adjusts how many options the model considers.',
      ...
      temperature: 'Temperature',
      temperatureHelp:
        'Controls response variation. Lower values make the output more objective and predictable; higher values increase creativity and variation.',
      topK: 'Top K',
      topKHelp:
        'Limits how many next-token options the model considers. Lower values keep the answer more focused; higher values increase diversity.',
      prompt: 'Prompt',
      ...
      ideaCards: [
        ...
        'Receipt and invoice reading with key fields.',
        'Screenshot analysis for internal support.',
        'Field briefing from photos and voice notes.',
        'Ticket triage from image, audio, and text.',
        'Risk matrix from multimodal evidence.',
      ],
    },
  },
  'es-ES': {
    translation: {
      ...
      generationControls: 'Controles',
      generationControlsHelp: 'Temperature ajusta la creatividad. Top K ajusta cuantas opciones considera el modelo.',
      ...
      temperature: 'Temperature',
      temperatureHelp:
        'Controla el nivel de variacion de la respuesta. Los valores bajos hacen la salida mas objetiva y predecible; los altos aumentan creatividad y variacion.',
      topK: 'Top K',
      topKHelp:
        'Limita cuantas opciones de siguiente token considera el modelo. Los valores bajos mantienen la respuesta mas enfocada; los altos aumentan diversidad.',
      prompt: 'Prompt',
      ...
      ideaCards: [
        'Resumen de reuniones con decisiones y proximos pasos.',
        'Lectura de recibos y facturas con campos clave.',
        'Analisis de capturas para soporte interno.',
        'Briefing de campo con fotos y notas de voz.',
        'Triagem de tickets por imagen, audio y texto.',
        'Matriz de riesgo con evidencias multimodales.',
      ],
    },
  },
};
